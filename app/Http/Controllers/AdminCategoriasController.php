	...
	class AdminCategoriasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
            ...
            $this->table_row_color[] = ['condition'=>'[estado] == "ACTIVA"', 'color'=>'success'];
			$this->table_row_color[] = ['condition'=>'[estado] == "INACTIVA"', 'color'=>'danger'];
	    ...
	    */
        ...
        public function getAdd (){
			$data['page_title'] = "Registrar Nueva Categoría";
            ...
            //dd($fecha_hora, $responsable_creacion, $estado_categoria);

			$this->cbView('categorias.crear', compact('data', 'fecha_hora',  'responsable_creacion', 'estado_categoria'));
		...
		public function store(CategoriaFormRequest $request)
		{
			try {
				...
				$categoria->estado=$request->input('slEstado');
				$categoria->observaciones=$request->input('txtObservaciones');
				...
				Alert::success('CATEGORÍA GUARDADA EXITOSAMENTE!', '');
				...
				Alert::error('ERROR AL AGREGAR LA CATEGORÍA, POR FAVOR VERIFIQUE!', '');
		...
		public function getEdit ($id){
			...
			$this->cbView('categorias.edit', compact('data', 'categoria',  'fecha_hora', 'responsable_edicion','estado_categoria'));

		}


		public function postCategoriasEdit(Request $request, $id)
			{
                $categoria = Categoria::findOrFail($id);
				...
				try {
					...
					Alert::success('CATEGORIA EDITADA EXITOSAMENTE!', '');
					...
					Alert::error('ERROR AL EDITAR LA CATEGORIA, POR FAVOR VERIFIQUE!', '');
 		...
 		public function getDetail ($id){
			$data['page_title'] = "Ver Detalles de la Categoría";

            $categoria = Categoria::findOrFail($id);

            //dd($id, $categoria);

			$this->cbView('categorias.show', compact('id', 'data', 'categoria'));
