	...
	class AdminProveedoresController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
        ...
        public function getAdd (){
			$data['page_title'] = "Registrar Nuevo Proveedor";
            ...
            //dd($fecha_hora, $responsable_creacion, $estado_proveedor);

			$this->cbView('proveedores.crear', compact('data', 'fecha_hora', 'responsable_creacion', 'estado_proveedor'));
		...
		public function store(ProveedorFormRequest $request)
		{
			try {
				...
				$proveedor->identificacion=$request->input('txtIdentificacion');
				$proveedor->nombres=$request->input('txtNombres');
				$proveedor->estado=$request->input('slEstado');
				$proveedor->correo=$request->input('txtCorreo');
				$proveedor->telefonos=$request->input('txtTelefonos');
				$proveedor->direccion=$request->input('txtDireccion');
				$proveedor->observaciones=$request->input('txtObservaciones');
				$proveedor->responsable_creacion=$request->input('txtResponsableCreacion');
				$proveedor->imagen=$request->input('imagen');

                if(Input::hasFile('imagen')){
					$file=Input::File('imagen');
					$file->move(public_path().'/imagenes/proveedores',$file->getClientOriginalName());
				...
				Alert::success('PROVEEDOR GUARDADO EXITOSAMENTE!', '');
				...
				Alert::error('ERROR AL AGREGAR EL PROVEEDOR, POR FAVOR VERIFIQUE!', '');
		...
		public function getEdit ($id){
			$data['page_title'] = "Editar Proveedor";
			...
			//dd($proveedor, $fecha_hora, $responsable_edicion, $estado_proveedor);

			$this->cbView('proveedores.edit', compact('data', 'proveedor',  'fecha_hora', 'responsable_edicion', 'estado_proveedor'));
		...
		public function postProveedorEdit (Request $request, $id)
			{
				...
				try {
                    ...
                    $proveedor->direccion=$request->input('txtDireccion');
                    $proveedor->observaciones=$request->input('txtObservaciones');
                    $proveedor->responsable_edicion=$request->input('txtResponsableEdicion');
                    //$proveedor->imagen=$request->input('imagen');
					...
					Alert::error('ERROR AL EDITAR EL PROVEEDOR, POR FAVOR VERIFIQUE!', '');
 		...
 		public function getDetail ($id){
			$data['page_title'] = "Ver Detalles del Proveedor";

			$proveedor = DB::table('proveedores')
			->join('cms_users', 'proveedores.responsable_creacion', '=', 'cms_users.id')
			->select('proveedores.*', 'cms_users.name as creado_por')
			->where('proveedores.id', $id)
			->get();

			//dd($proveedor);

			$this->cbView('proveedores.show', compact('id', 'data', 'proveedor'));
