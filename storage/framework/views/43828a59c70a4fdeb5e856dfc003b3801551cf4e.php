                    ...
                    <div class="row">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="pslProducto" id="pslProducto" class="form-control style="width: 100%" required>
                                            ...
                                            <option value="<?php echo e($producto->id); ?>_<?php echo e($producto->referencia); ?>_<?php echo e($producto->stock); ?>_<?php echo e($producto->ultimo_precio); ?>"><?php echo e($producto->producto_completo); ?></option>
                                ...
                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                    <div class="form-group">
                                        <input type="hidden" name="ptxtIdVenta" id="ptxtIdVenta" class="form-control" value="<?php echo e($detalles->venta_id); ?>" readonly="true">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade modal-slide-in-right" aria-hidden="true"
role="dialog" tabindex="-1" id="modal-delete-<?php echo e($detalles->id); ?>">
    <form action="/admin/ventas/delete/<?php echo e($detalles->id); ?>" method="POST">
