                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="slProducto" id="slProducto" class="form-control selectpicker"
                                        ...
                                        <option
                                            value="<?php echo e($producto->id); ?>_<?php echo e($producto->referencia); ?>_<?php echo e($producto->stock); ?>_<?php echo e($producto->ultimo_precio); ?>">
                                            <?php echo e($producto->producto_completo); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
