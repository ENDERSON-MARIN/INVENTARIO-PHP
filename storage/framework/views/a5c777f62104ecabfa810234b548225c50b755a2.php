                                ...
                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                    <div class="form-group">
                                        <input type="hidden" name="ptxtIdCompra" id="ptxtIdCompra"
                                            class="form-control" value="<?php echo e($detalles->compra_id); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1"
    id="modal-delete-<?php echo e($detalles->id); ?>">
    <form action="/admin/compras/delete/<?php echo e($detalles->id); ?>" method="POST">
