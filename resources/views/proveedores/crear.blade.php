...
<div class="panel panel-warning">
    <div class="panel-heading text-center" style="height: 30px;padding:0;">
        <strong>REGISTRAR NUEVO PROVEEDOR</strong>
    </div>
    ...
    <div class="panel-body">
        <form action="/admin/proveedores" method="post" enctype="multipart/form-data">
            ...
            <div class="row ">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>***NOMBRES***</label>
                        <input type="text" class="form-control" name="txtNombres" id="txtNombres"  placeholder="Ingrese el nombre y apellido del proveedor" required>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="txtIdentificacion" id="txtIdentificacion"  placeholder="Ingrese la identificacion del proveedor" required>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="txtDireccion" id="txtDireccion"  class="form-control" placeholder="Ingrese la dirección del proveedor">
                    </div>
                </div>
                ...
                <div class="col-sm-12 ">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="txtObservaciones" id="txtObservaciones" cols="30" rows="5"  placeholder="Ingrese las observaciones del proveedor"></textarea>
                    </div>
                </div>
            ...
            <div class="panel-footer text-center ">
                ...
                <button type="submit" class="btn btn-success">Registrar Nuevo Proveedor</button>
            </div>
        </form>
    </div>
